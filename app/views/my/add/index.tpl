...
<form method="post" action="" name="form">
	...
	<h2>1. Where do you want to hear about?</h2>
	<p>Move the map to the area that you want to get notifications for:</p>
	<div id="map"></div>
	<input type="hidden" name="bbox" id="bbox" />
	
	<h2>2. What do you want to hear about?</h2>
	<p>You can also limit notifications to planning applications in this to match particular things, or hear about everything:</p>
	<div id="filtering">
